      ...
      <div class="grid md:grid-cols-4 gap-10 mb-16">
        ...
        <div>
          ...
          <div class="flex gap-4">
            ...
            <a class="w-10 h-10 hover:text-black hover:scale-110 flex items-center justify-center rounded-full transition">
