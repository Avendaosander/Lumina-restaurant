<template>
  <footer class="bg-[#0a0a0a] text-white pt-20 pb-10 border-t border-white/10">
    ...
    <div class="container">
      ...
      <div class="grid md:grid-cols-4 gap-10 mb-16">
        ...
        <!-- BRAND -->
        <div>
          <h2 class="text-3xl font-bold tracking-[0.3em] text-yellow-400 mb-4">
            LÚMINA
          </h2>

          <p class="text-gray-400 leading-relaxed">
            A luxury dining experience where culinary art meets elegance and innovation.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400">
            ...
            <li>
              <a href="#menu" class="hover:text-yellow-400 transition">
                Menu
              </a>
            </li>

            <li>
              <a href="#gallery" class="hover:text-yellow-400 transition">
                Gallery
              </a>
            </li>

            <li>
              <a href="#reservations" class="hover:text-yellow-400 transition">
                Reservations
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <div class="flex gap-4">
            ...
            <a class="w-10 h-10 bg-white/10 hover:bg-yellow-400 hover:text-black flex items-center justify-center rounded-full transition">
            ...
            <a class="w-10 h-10 hover:text-black flex items-center justify-center rounded-full transition">
      ...
      <div class="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
        ...
        <p>
          © 2026 Lúmina Restaurant. All rights reserved.
        </p>

        <p class="mt-2 md:mt-0">
          Designed with passion & Vue
        </p>
