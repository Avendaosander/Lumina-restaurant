<template>
  <footer class="w-full overflow-x-clip border-t border-white/10 bg-[#0a0a0a] pt-20 pb-10 text-white max-md:pt-14 max-md:pb-8">

    <div class="container min-w-0 max-w-full px-3 sm:px-4">

      <div
        class="mb-12 grid grid-cols-1 gap-10 text-center sm:grid-cols-2 sm:gap-8 md:mb-16 md:grid-cols-4 md:gap-10 md:text-left"
      >
        <div class="flex flex-col items-center md:items-start">
          <h2 class="navbar-brand mb-4 text-2xl font-bold tracking-[0.2em] text-yellow-400 sm:text-3xl sm:tracking-[0.3em]">
            LÚMINA
          </h2>

          <p class="max-w-xs text-sm leading-relaxed text-gray-400 sm:max-w-none sm:text-base">
            Una experiencia gastronómica de lujo donde el arte culinario se une a la elegancia y la innovación.
          </p>
        </div>
        ...
        <div class="flex flex-col items-center md:items-start">
          ...
          <ul class="space-y-2.5 text-sm text-gray-400 sm:text-base">
            <li>
              <a href="#home" class="transition hover:text-yellow-400">
                Inicio
              </a>
            </li>
            <li>
              <a href="#menu" class="transition hover:text-yellow-400">
                Menú
              </a>
            </li>
            <li>
              <a href="#gallery" class="transition hover:text-yellow-400">
                Galería
              </a>
            </li>
            <li>
              <a href="#reservations" class="transition hover:text-yellow-400">
                Reservas
              </a>
            </li>
          </ul>
        ...
        <div class="flex flex-col items-center md:items-start">
          ...
          <ul class="space-y-2.5 text-sm text-gray-400 sm:text-base">
            ...
            <li>
              <a href="tel:+582125551234" class="transition hover:text-yellow-400">
                +58 212 555 1234
              </a>
            </li>
            <li>
              <a href="mailto:contact@lumina.com" class="transition hover:text-yellow-400">
                contact@lumina.com
              </a>
            </li>
          </ul>
        ...
        <div class="flex flex-col items-center sm:col-span-2 md:col-span-1 md:items-start">
          <h3 class="mb-4 text-base font-semibold text-white sm:text-lg">
            Síguenos
          </h3>
          ...
          <div class="flex justify-center gap-3 md:justify-start">
            ...
            <a
              ...
              class="flex h-11 w-11 items-center justify-center rounded-full transition hover:scale-110 hover:bg-yellow-400 hover:text-black"
            >
              <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 1200 1227" aria-hidden="true"><path fill="currentColor" d="M714.163 519.284 1160.89 0h-105.86L667.137 450.887 357.328 0H0l468.492 681.821L0 1226.37h105.866l409.625-476.152 327.181 476.152H1200L714.137 519.284h.026ZM569.165 687.828l-47.468-67.894-377.686-540.24h162.604l304.797 435.991 47.468 67.894 396.2 566.721H892.476L569.165 687.854v-.026Z"/></svg>
            </a>
          </div>
        </div>
      ...
      <div
        class="flex flex-col items-center gap-2 border-t border-white/10 pt-6 text-center text-xs text-gray-500 sm:text-sm md:flex-row md:justify-between md:text-left"
      >
        <p>© 2026 Lúmina Restaurant. All rights reserved.</p>
        <p>Diseñado con pasión en Vue</p>
      </div>
